<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="arabaSat.KategoriDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: auto;">
        ...
        <asp:DataList ID="DataList2" runat="server">
            <ItemTemplate>
                <a href="ArabaDetay.aspx?ArabaID=<%# Eval("ArabaID")%>">
